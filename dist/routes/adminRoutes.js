...
router.get('/user-list', adminController_1.adminController.getUsers);
router.get('/employee-list', adminController_1.adminController.getEmployees);
router.post('/add-category', multer_1.upload.fields([{ name: 'image', maxCount: 1 }]), (req, res) => {
